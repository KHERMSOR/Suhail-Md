...
global.readmessagefrom = process.env.READ_MESSAGE_FROM || "254788281042,254xxxxxxxx";
...
module.exports = {
  ...
  author : process.env.PACK_AUTHER|| "Khermsor",
  packname: process.env.PACK_NAME || "⚜️",
  botname : process.env.BOT_NAME  || "khermsor254",
  ownername:process.env.OWNER_NAME|| "It'x khermsor",
